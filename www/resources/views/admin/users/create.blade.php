...
@section('page_title', 'Cadastrar Usuário Administrativo')
    ...
    <form action="{{ route('admin.users.store') }}" method="POST">
        ...
        <div class="row g-4">
            ...
            <div class="col-md-6">
                ...
                <input type="email" class="form-control @error('email') is-invalid @enderror" id="email" name="email" value="{{ old('email') }}" required placeholder="Ex: alessandro@comanda.com">
                @error('email')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
